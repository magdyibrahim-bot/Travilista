...
require_once ('files/display-trips.php');
protected_area();
?>
<?php
...
<body>
    ...
    <div class="container">
        ...
        <div class="search-bar mb-4">
            <input type="text" id="priceSearch" class="form-control" placeholder="Search by price (e.g., $25.00)">
        </div>
        <br>
        <?php while ($row = $result->fetch_assoc()): ?>
            <section id="display">
                ...
                <!-- Cards Section -->
                <section id="cards">
                    <div class="card mb-3" style="max-width: 700px;" data-aos="fade-down-left" data-price="30.00">
                        <div class="row g-0">
                            <div class="col-md-4">
                                <img src="<?php echo $row['image']; ?>" class="img-fluid rounded-start" alt="Luxor Trip">
                            </div>
                            <div class="col-md-8">
                                <div class="card-body">
